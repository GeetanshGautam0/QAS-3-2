...
OutputDir=C:\Users\geeta\OneDrive\Documents\2. Electronics\1. Python\QAS 3-2\installer
OutputBaseFilename=QuizzingAppInstaller
SetupIconFile=C:\Users\geeta\OneDrive\Documents\2. Electronics\1. Python\QAS 3-2\.src\.icons\.app_ico\setup.ico
Compression=lzma
...
[Tasks]
Name: "addons_theme"; Description: "Download and install 'Official Themes Addon' package"; GroupDescription: "ADDONS"; Flags: unchecked
Name: "addons_font"; Description: "Install recommended font (HIGHLY RECOMMENDED)"; GroupDescription: "ADDONS"

[Files]
Source: "C:\Users\geeta\OneDrive\Documents\2. Electronics\1. Python\QAS 3-2\installer\.config\*"; DestDir: "{app}\.config"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\geeta\OneDrive\Documents\2. Electronics\1. Python\QAS 3-2\installer\.qa_update\*"; DestDir: "{app}\.qa_update"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Type: filesandordirs; Name: "{app}\qa_gem"
