...
def test_src_files() -> None:
    ...
    excl = ('.vs', '.vscode', 'QAS_VENV', 'venv', 'unins000.dat', 'unins000.exe', '.qa_update', 'TODO', 'additional_themes', '.git', '.idea', '.mypy_cache', '.pytest_cache', '__pycache__', '', 'dist', 'build', 'installer')
    addons = ('ADDONS_THEME', )
    lsa = []
...
def test_installer_iss() -> None:
    ...
    rt = "<test::uninstaller>"
    excl = ('.vs', '.vscode', 'QAS_VENV', 'venv', 'unins000.dat', 'unins000.exe', 'TODO', '.git', '.idea', '__pycache__', '.mypy_cache', '.pytest_cache', 'additional_themes', 'build', 'dist', 'installer')
